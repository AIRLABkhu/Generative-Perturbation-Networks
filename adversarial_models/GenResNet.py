...
class GenResNet(nn.Module):
    def __init__(self, in_channel, in_height, in_width):
        ...
        self.conv1 = nn.Conv2d(in_channel, ngf, kernel_size=7, padding=0, bias=use_bias)
        ...
        self.res_layer1 = self._make_layer(ZeroPadBlock, depth, res_block, stride=1)
        ...
        self.conv3 = nn.Conv2d(depth, in_channel, kernel_size = 7, padding = 0)
        self.conv_act3 = nn.Tanh()
        # self.conv_act3 = nn.Sigmoid()
...
class GenResNet(nn.Module):
    def __init__(self, in_channel, in_height, in_width):
        ...
        self.res_layer2 = self._make_layer(ZeroPadBlock, depth, res_block, stride=1)
        self.res_layer3 = self._make_layer(ZeroPadBlock, depth, res_block, stride=1)
        self.res_layer4 = self._make_layer(ZeroPadBlock, depth, res_block, stride=1)
        self.res_layer5 = self._make_layer(ZeroPadBlock, depth, res_block, stride=1)
        self.res_layer6 = self._make_layer(ZeroPadBlock, depth, res_block, stride=1)
