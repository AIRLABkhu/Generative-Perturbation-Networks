...
class GenResNetMulti(nn.Module):
    def __init__(self, in_channel, in_height, in_width, n_channel):
        super(GenResNetMulti, self).__init__()
        ...
        self.conv3 = nn.Conv2d(depth, n_channel, kernel_size = 7, padding = 0)
